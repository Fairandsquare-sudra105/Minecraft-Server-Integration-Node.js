...
class FabricEngine {
    async download(config, serverDir) {
        const downloadInfo = Downloader_1.Downloader.getFabricURL(config.version);
...
exports.FabricEngine = FabricEngine;
//# sourceMappingURL=FabricEngine.js.map